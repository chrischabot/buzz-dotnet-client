...
namespace Google.Api.Buzz.Utils {
	...
	public class Constants {
      ...
      public const string ORGNIZATIONS = "organizations";
      ...
      public const string URI_COMMENTS = "@comments";
	  public const string URI_LIKED = "@liked";
	  public const string URI_ME ="@me";
      public const string URI_ALL = "@all";
      ...
      public const string URI_GROUPS = "@groups/";
      public const string URI_FOLLOWERS = "@followers";
      public const string URI_FOLLOWING = "@following";
